            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart.data.datasets[0].label === "Kas(Kekurangan)") {
                        ...
                        chart.data.datasets[0].data = [0, 1000, 5000, 6000, 0];
                    }
...
const chart1 = new Chart(ctx1, {
    ...
    data: {
        ...
        datasets: [{
            label: "Kas",
            data: [6000, 5000, 2000, 5000, 13000],
        }]
    },
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart1.data.datasets[0].label === "Kas") {
                        ...
                        chart1.data.datasets[0].data = [6000, 5000, 2000, 5000, 13000];
                    }
