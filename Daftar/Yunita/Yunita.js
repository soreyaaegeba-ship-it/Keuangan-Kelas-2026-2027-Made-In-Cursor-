...
const chart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [24000, 23000, 29000, 30000, 34000],
            borderColor: "red",
            pointBackground: "red"
        }]
    },
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart.data.datasets[0].label === "Kas(Kekurangan)") {
                        ...
                        chart.data.datasets[0].data = [24000, 23000, 29000, 30000, 34000];
                    }ksksksk
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart1.data.datasets[0].label === "Kas") {
                        ...
                        chart1.data.datasets[0].data = [0, 7000, 0, 5000, 0];
                    }
