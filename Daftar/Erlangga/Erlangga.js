...
const chart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [4000, 10000, 14000, 10000, 10000],
            borderColor: "red",
            pointBackground: "red"
        }]
    },
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart.data.datasets[0].label === "Kas(Kekurangan)") {
                        ...
                        chart.data.datasets[0].data = [4000, 10000, 14000, 10000, 10000];
                    }
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart1.data.datasets[0].label === "Kas") {
                        ...
                        chart1.data.datasets[0].data = [2000, 0, 2000, 10000, 6000];
                    }
