            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart.data.datasets[0].label === "Kas(Kekurangan)") {
                        ...
                        chart.data.datasets[0].data = [3000, 4000, 0, 1000, 0];
                    }
...
const chart1 = new Chart(ctx1, {
    ...
    data: {
        ...
        datasets: [{
            label: "Kas",
            data: [3000, 5000, 10000, 5000, 7000],
        }]
    },
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart1.data.datasets[0].label === "Kas") {
                        ...
                        chart1.data.datasets[0].data = [3000, 5000, 10000, 5000, 7000];
                    }
