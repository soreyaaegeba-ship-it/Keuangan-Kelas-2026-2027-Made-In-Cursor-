...
const chart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [16000, 20000, 26000, 27000, 31000],
            borderColor: "red",
            pointBackground: "red"
        }]
    },
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart.data.datasets[0].label === "Kas(Kekurangan)") {
                        ...
                        chart.data.datasets[0].data = [16000, 20000, 26000, 27000, 31000];
                    }
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart1.data.datasets[0].label === "Kas") {
                        ...
                        chart1.data.datasets[0].data = [2000, 2000, 0, 5000, 0];
                    }
