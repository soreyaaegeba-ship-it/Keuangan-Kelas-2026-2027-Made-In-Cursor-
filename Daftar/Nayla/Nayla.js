...
const chart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [2000, 8000, 8000, 11000, 15000],
            borderColor: "red",
            pointBackground: "red"
        }]
    },
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart.data.datasets[0].label === "Kas(Kekurangan)") {
                        ...
                        chart.data.datasets[0].data = [2000, 8000, 8000, 11000, 15000];
                    }
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart1.data.datasets[0].label === "Kas") {
                        ...
                        chart1.data.datasets[0].data = [4000, 0, 6000, 3000, 2000];
                    }
