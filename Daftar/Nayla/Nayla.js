...
const chart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            ...
            data: [11000, 15000, 21000, 24000, 24000],
            borderColor: "red",
            pointBackground: "red"
        }]
    },
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart.data.datasets[0].label === "Kas(Kekurangan)") {
                        ...
                        chart.data.datasets[0].data = [11000, 15000, 21000, 24000, 24000];
                    }
            ...
            legend: {
                onClick: function(e, legendItem, legend) {
                    ...
                    if (chart1.data.datasets[0].label === "Kas") {
                        ...
                        chart1.data.datasets[0].data = [3000, 2000, 0, 3000, 4000];
                    }
